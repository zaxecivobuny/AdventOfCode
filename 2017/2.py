...
def find_divs_in_row(row):
	for i in range(0,len(row)):
		for j in range(i+1, len(row)):
			r = even_divide_test(row[i], row[j])
			if not r == 0:
				return r
...
# 7 5 3
# 2 4 6 8"""
start = """116	1470	2610	179	2161	2690	831	1824	2361	1050	2201	118	145	2275	2625	2333
...
for row in grid:
    # largest = max(row)
    # smallest = min(row)
    # sum += int(largest) - int(smallest)
    # print row
    # print largest
    # print smallest
    sum += find_divs_in_row(row)
    

print sum

print find_divs_in_row([1,2,3,4])
